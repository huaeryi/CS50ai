...
knowledge2 = And(
    Biconditional(AKnight, Not(AKnave)),
    Biconditional(BKnight, Not(BKnave)),
    Biconditional(And(Biconditional(AKnight, BKnight), Biconditional(AKnave, BKnave)), AKnight),
    Biconditional(And(Biconditional(AKnight, BKnave), Biconditional(AKnave, BKnight)), BKnight)
)
